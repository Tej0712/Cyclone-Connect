...
public class admin_headstart_update_specificcourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_headstart_update_specificcourse);
    ...
    private void updateSpecificCourse() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.PUT, url, requestBody,
                response -> {
                    Toast.makeText(admin_headstart_update_specificcourse.this, "Specific course updated successfully", Toast.LENGTH_SHORT).show();
                    finish();
                },
                error -> {
                    error.printStackTrace();
                    Toast.makeText(admin_headstart_update_specificcourse.this, "Failed to update specific course", Toast.LENGTH_SHORT).show();
                });
